...
import com.zhowin.brainwave.OnMessageArrivedListener;
...
public class MyMqttService extends Service {
    ...
    public final String TAG = "xy";
    private static MqttAndroidClient mqttAndroidClient;
    private MqttConnectOptions mMqttConnectOptions;
    public String HOST = "tcp://192.168.1.241:1883";//服务器地址（协议+地址+端口号）
    //质量等级
    public static int qosInt = 2;
    ...
    private IMqttActionListener iMqttActionListener = new IMqttActionListener() {
        ...
        public void onSuccess(IMqttToken arg0) {
            Log.i(TAG, "连接成功 ");
            try {
                mqttAndroidClient.subscribe(PUBLISH_TOPIC, qosInt);//订阅主题，参数：主题、服务质量
            } catch (MqttException e) {
                e.printStackTrace();
            }
        }
